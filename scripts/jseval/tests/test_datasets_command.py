...
def test_gate_coverage_reads_real_committed_files():
    ...
    # tempdoc 701: union-recall-gate joins the three pre-existing ratchets; its baselines file is
    ...
    assert "beir/scifact" in coverage["union-recall-gate"]  # tempdoc 701
