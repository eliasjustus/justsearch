---
description: "Check nearby tempdoc numbers, active worktrees, and open PRs for numeric or file-level collisions with the current tempdoc's remaining work. Rare — run manually only."
