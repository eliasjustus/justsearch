...
*   **Flow:**
    ...
    2.  The system goes idle (the enrichment backfill runs on idle cycles) and/or the user triggers the "Finish enrichment now" operation (`core.trigger-offline-processing`).
