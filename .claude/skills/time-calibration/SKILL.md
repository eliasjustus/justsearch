---
description: "Estimate vs. actual implementation time for past tempdocs, to calibrate confidence about the current tempdoc's likely duration. Rare — run manually only."
