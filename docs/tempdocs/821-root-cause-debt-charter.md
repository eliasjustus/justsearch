...
type: tempdocs
status: "CHARTER + DERISKED (2026-08-12) — census complete, classes mapped, §L derisking pass done (adversarial verdict audit, C1 authority maps, C2 blast-radius probes, 792 merge dry-run). Three §3/§4 exemplars were REFUTED as already-fixed and are corrected in place; §6.1 wholesale deletion is retracted (33% refutation rate in the deletion stratum — see §L.1). Awaiting owner prioritization at §7. Nothing here is implemented; §2c tempdoc items are UNVERIFIED candidates."
created: 2026-08-12
