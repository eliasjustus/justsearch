...
status: >-
  IN PROGRESS — S0 (merged, #493); S1 (merged, #495); S2 (merged, #503); S3 (merged, #505).
...
forcing-function: >-
  `check-window-cutover` (shipped with 851) WARNs until 2026-09-30 and FAILS
...
related: >-
  847 (citation correctness — S1-S3 shipped in #488; 852-S1 is sequenced strictly behind
