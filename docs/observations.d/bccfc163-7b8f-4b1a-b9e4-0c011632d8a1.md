...
- [ ] check-controls-a11y is RED on main: 1 title-on-disabled in shell-v0/views/UnifiedChatView.ts over baseline 0 (verified against origin/main, pre-existing) — `modules/ui-web/src/shell-v0/views/UnifiedChatView.ts:2143` (2026-08-19)
