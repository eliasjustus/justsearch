...
`kind: defect?` `anchor: scripts/dev/dev-runner.cjs` `seen: 4` `first: 2026-07-14` `last: 2026-08-10`
...
`kind: lesson?` `anchor: modules/system-tests/.../harness/IsolatedBackendFixture.java` `seen: 2` `first: 2026-05-27` `last: 2026-08-13`
...
`kind: defect?` `anchor: modules/app-services/.../KnowledgeSearchEngine.java` `seen: 7` `first: 2026-06-12` `last: 2026-08-13`
...
`kind: defect?` `anchor: ui-a11y-baseline.v1.json` `seen: 3` `first: 2026-07-12` `last: 2026-08-06`
...
`kind: defect?` `anchor: modules/worker-services/src/main/java/io/justsearch/indexerworker/loop/ops/CombinedEnrichmentBackfillOps.java` `seen: 6` `first: 2026-07-11` `last: 2026-08-06`
...
`kind: defect?` `anchor: modules/worker-services/src/main/java/io/justsearch/indexerworker/loop/ops/IndexingDocumentOps.java` `seen: 2` `first: 2026-07-11` `last: 2026-08-13`
...
- [ ] The Lucene doc-id key family still spells the pre-P3 derivation inline in ~8 places (normalizePath(p.toAbsolutePath()) with no Path.normalize()) — SqliteJobQueue:323,457,624,973, IndexingDocumentOps:134,393, LedgerEntryFactory:27, StaleSourceHandler:39, WorkerMethvinWatcher:279, SyncDirectoryOps:314,339, CloudPlaceholderRecorder:51; same divergence class 821 P3 just converged for the forced-path key, different key family (doc id), left untouched as out of scope — `modules/worker-services/src/main/java/io/justsearch/indexerworker/loop/ops/IndexingDocumentOps.java:134` (2026-08-13)
...
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/views/UnifiedChatView.ts` `seen: 7` `first: 2026-07-14` `last: 2026-08-13`
...
`kind: follow-up?` `anchor: McpToolSurface.java` `seen: 3` `first: 2026-07-14` `last: 2026-08-12`
...
`kind: environment?` `anchor: expected-state.v1.json` `seen: 5` `first: 2026-07-15` `last: 2026-08-13`
...
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/themes/token-names.generated.ts` `seen: 3` `first: 2026-07-15` `last: 2026-08-07`
...
`kind: defect?` `anchor: AiInstallService.java` `seen: 5` `first: 2026-07-14` `last: 2026-08-13`
...
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/views/BrainSurface.ts` `seen: 2` `first: 2026-07-15` `last: 2026-08-06`
...
`kind: defect?` `anchor: modules/ui/src/main/java/io/justsearch/ui/api/LocalApiServer.java` `seen: 3` `first: 2026-07-14` `last: 2026-08-13`
...
`kind: follow-up?` `anchor: scripts/agent-analytics/lib/transcript-cost.mjs` `seen: 3` `first: 2026-07-16` `last: 2026-07-28`
...
`kind: follow-up?` `anchor: scripts/agent-analytics/fold-observations.mjs` `seen: 4` `first: 2026-07-16` `last: 2026-08-13`
...
`kind: defect?` `anchor: scripts/agent-analytics/note-observation.mjs` `seen: 3` `first: 2026-07-17` `last: 2026-08-13`
...
`kind: environment?` `anchor: modules/ui/src/test/java/io/justsearch/ui/api/LifecycleContractTest.java` `seen: 5` `first: 2026-07-22` `last: 2026-08-13`
...
`kind: environment?` `anchor: scripts/ci/workflow-signal-policy.v1.json` `seen: 1` `first: 2026-07-30` `last: 2026-07-30`
...
`kind: follow-up?` `anchor: fields.v1.json` `seen: 2` `first: 2026-08-03` `last: 2026-08-12`
...
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/views/LibrarySurface.ts` `seen: 2` `first: 2026-08-06` `last: 2026-08-12`
...
`kind: defect?` `anchor: shell-v0/components/searchResults/ResultsCard.ts` `seen: 1` `first: 2026-08-06` `last: 2026-08-06`
...
`kind: defect?` `anchor: modules/shell/src-tauri/src/lib.rs` `seen: 1` `first: 2026-08-04` `last: 2026-08-04`
...
`kind: defect?` `anchor: modules/ui-web/src/api/domains/agent.ts` `seen: 2` `first: 2026-08-05` `last: 2026-08-12`
...
`kind: defect?` `anchor: modules/adapters-lucene/src/main/java/io/justsearch/adapters/lucene/runtime/RagContextOps.java` `seen: 1` `first: 2026-08-06` `last: 2026-08-06`
...
`kind: defect?` `anchor: modules/app-services/src/main/java/io/justsearch/app/services/settings/UiSettingsStore.java` `seen: 1` `first: 2026-08-06` `last: 2026-08-06`
...
`kind: environment?` `anchor: modules/app-services/src/main/java/io/justsearch/app/services/worker/RemoteKnowledgeClient.java` `seen: 3` `first: 2026-08-06` `last: 2026-08-06`
...
`kind: defect?` `anchor: modules/app-services/src/main/java/io/justsearch/app/services/worker/RootLifecycleOps.java` `seen: 2` `first: 2026-08-12` `last: 2026-08-12`
...
`kind: environment?` `anchor: docs/tempdocs/530-class-size-ratchet-automation.md` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
`kind: defect?` `anchor: modules/shell/src-tauri/tauri.conf.json` `seen: 1` `first: 2026-08-06` `last: 2026-08-06`
...
### obs:textqueryops — Multi-leg search legs silently ignore request query_syntax=LUCENE: TextQueryOps.searchText/searchTex
`kind: defect?` `anchor: modules/adapters-lucene/src/main/java/io/justsearch/adapters/lucene/runtime/TextQueryOps.java` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:health-readiness-contract-v1 — health-readiness-contract.v1.md's READY sample shows `"reasonCode": null` but ReadinessComponentView
`kind: environment?` `anchor: docs/reference/contracts/health-readiness-contract.v1.md` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:statuslifecyclehandler — GPU readiness can report DEGRADED/gpu.saturated from placeholder data when the Worker RPC fails: com
`kind: defect?` `anchor: modules/ui/src/main/java/io/justsearch/ui/api/StatusLifecycleHandler.java` `seen: 2` `first: 2026-08-12` `last: 2026-08-13`
...
### obs:unanchored-general-9 — jseval env trap: scoop `python` (python313) lacks ir_measures/jseval deps — the working interpreter 
`kind: defect?` `anchor: none` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:unanchored-general-12 — jseval interpreter trap resolved: scoop python313 site-packages had lost ir_measures/ir_datasets (li
`kind: defect?` `anchor: none` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:unanchored-missing-4 — LIVE-CONFIRMED (821 needs-live session): the 'Semantic search degraded' banner's retrieval composite
`kind: defect?` `anchor: none` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:unanchored-general-14 — LIVE-CONFIRMED severe (821 needs-live session): embedding fingerprint never persists — TWO consecuti
`kind: defect?` `anchor: none` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:unanchored-missing-6 — LIVE-CHECKED (821 needs-live session): obs:unanchored-missing-2 partial — CE cold query executed 426
`kind: defect?` `anchor: none` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:unanchored-general-15 — LIVE root-cause (Search v3 skeleton-stuck report): /api/shell-events/stream floods ~200KB/s on an 85
`kind: defect?` `anchor: none` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:tikaocrruntimetest — TikaOcrRuntimeTest.languageProbeUsesPackagedTessdataPrefix fails locally with ocr.language_missing (
`kind: environment?` `anchor: modules/worker-services/src/test/java/io/justsearch/indexerworker/extract/TikaOcrRuntimeTest.java` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:lambdamartbenchmarktest — Flaky under machine load: LambdaMartBenchmarkTest#inferenceLatencyUnder5ms failed with p99 99.85ms v
`kind: environment?` `anchor: modules/app-services/src/integrationTest/java/io/justsearch/app/services/gpl/LambdaMartBenchmarkTest.java` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:check-api-client-regen — check-api-client-regen freshness gate is not wired into CI or gradle — a stale generated apiRoutes.t
`kind: follow-up?` `anchor: check-api-client-regen` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:protobuf-truth-table — wire gate cannot demand changesets for ADDITIVE contract changes: protobuf-truth-table.mjs:28-34 row
`kind: defect?` `anchor: protobuf-truth-table.mjs` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:jvmbaseconventionsplugin — Repo-wide junit.jupiter.execution.timeout.default=30s governs EVERY @BeforeAll (class-level @Timeout
`kind: environment?` `anchor: build-logic/src/main/kotlin/conventions/JvmBaseConventionsPlugin.kt` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:unanchored-general-16 — TRAP: a PR in CONFLICTING state never gets a `pull_request` CI run at all (GitHub cannot build refs/
...
### obs:localapihostvalidationtest — CORRECTED (was: "Javalin's exception mapper may drop the Host/token guards' deny bodies in productio
`kind: defect?` `anchor: modules/ui/src/test/java/io/justsearch/ui/api/LocalApiHostValidationTest.java` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:apisecurityfilters — ApiSecurityFilters.resolveAllowedOrigin rejects IPv6 loopback origins (http://[::1]:port) because UR
`kind: defect?` `anchor: modules/ui/src/main/java/io/justsearch/ui/api/ApiSecurityFilters.java` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:mcpprotocolhandler — RESOLVED by the MCP conformance lane (this branch): GET /mcp now returns 405 + `Allow: POST, DELETE,
`kind: defect?` `anchor: McpProtocolHandler.java` `seen: 3` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:inferencelifecyclemanager — BKD-005 (from retired docs/reference/issues, 821 D5): inference mode transitions (CPU->GPU, model sw
`kind: defect?` `anchor: modules/app-inference/src/main/java/io/justsearch/app/inference/InferenceLifecycleManager.java` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:onlinemodeops — BKD-012 (from retired docs/reference/issues, 821 D5; matches 821 class C3/C4 stream-cancellation): s
`kind: defect?` `anchor: modules/app-inference/src/main/java/io/justsearch/app/inference/OnlineModeOps.java` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:grpcingestservice — BKD-013 (from retired docs/reference/issues, 821 D5): user-configured exclude patterns are applied p
`kind: defect?` `anchor: modules/worker-services/src/main/java/io/justsearch/indexerworker/services/GrpcIngestService.java` `seen: 4` `first: 2026-08-12` `last: 2026-08-13`
...
- [ ] GrpcIngestService#sanitizePath over-rejects legitimate filenames: DANGEROUS_COMPONENTS is checked with raw pathStr.contains(''..''), so any directory or file whose NAME contains two consecutive dots (e.g. C:\notes..archive\a.txt) is refused as a traversal attempt before the real Path.normalize()+isAbsolute checks that already make it safe — `modules/worker-services/src/main/java/io/justsearch/indexerworker/services/GrpcIngestService.java:616` (2026-08-13)

### obs:unanchored-general-17 — BKD-015 (from retired docs/reference/issues, 821 D5): encrypted/corrupt/unsupported files are indexe
`kind: defect?` `anchor: none` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:sqlitejobqueue — BKD-016 (from retired docs/reference/issues, 821 D5): SQLite job queue has write contention / WAL ch
`kind: defect?` `anchor: modules/indexer-worker/src/main/java/io/justsearch/indexerworker/queue/SqliteJobQueue.java` `seen: 2` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:unanchored-error — BKD-018 (from retired docs/reference/issues, 821 D5): no backup/restore path for the Lucene index — 
`kind: defect?` `anchor: none` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:structuredcontenthandler — BKD-023 (from retired docs/reference/issues, 821 D5; still live, re-verified 2026-08-12): once the e
`kind: defect?` `anchor: modules/worker-services/src/main/java/io/justsearch/indexerworker/extract/StructuredContentHandler.java` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:indexingjobschangestream — BKD-024 (from retired docs/reference/issues, 821 D5; still live, re-verified 2026-08-12): IndexingJo
`kind: defect?` `anchor: modules/indexer-worker/src/main/java/io/justsearch/indexerworker/queue/IndexingJobsChangeStream.java` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:workerspawner — BKD-025 (from retired docs/reference/issues, 821 D5; UNVERIFIED static-audit hypotheses, confirm aga
`kind: defect?` `anchor: modules/app-services/src/main/java/io/justsearch/app/services/worker/WorkerSpawner.java` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:gpucapabilitiesservice — GPU-001 residue (from retired docs/reference/issues, 821 D5): AMD/Intel GPUs are not detected and su
`kind: defect?` `anchor: modules/gpu-bridge/src/main/java/io/justsearch/gpu/GpuCapabilitiesService.java` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:nvmlservice — GPU-004 (from retired docs/reference/issues, 821 D5): NvmlService queries deviceCount but only ever 
`kind: defect?` `anchor: modules/gpu-bridge/src/main/java/io/justsearch/gpu/NvmlService.java` `seen: 2` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:cudaruntimedetection — GPU-013 (from retired docs/reference/issues, 821 D5; still live, verified 2026-08-12 — no getenv(PAT
`kind: defect?` `anchor: modules/app-inference/src/main/java/io/justsearch/app/inference/CudaRuntimeDetection.java` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:onnxsessioncache — INS-004 residue (from retired docs/reference/issues, 821 D5): ORT FP16-on-CPU was only partially fix
`kind: defect?` `anchor: modules/ort-common/src/main/java/io/justsearch/ortcommon/OnnxSessionCache.java` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:a11y-runner — UIX-006 successor (from retired docs/reference/issues, 821 D5): no automated accessibility check run
`kind: defect?` `anchor: scripts/ci/a11y-runner.sh` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:textanalysisutils — ACC-003 (from retired docs/reference/issues, 821 D5; still present, verified 2026-08-12): match-reas
`kind: defect?` `anchor: modules/worker-services/src/main/java/io/justsearch/indexerworker/util/TextAnalysisUtils.java` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
...
### obs:watchedrootscancollectiontest — WatchedRootScanCollectionTest$ProductionWireForwarding intermittently fails the FULL app-services su
`kind: defect?` `anchor: modules/app-services/src/test/java/io/justsearch/app/services/worker/WatchedRootScanCollectionTest.java` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:upgradelifecyclecontracttest — Flaky under full-suite load (same HttpTimeoutException class as the LifecycleContractTest entries): 
`kind: environment?` `anchor: modules/ui/src/test/java/io/justsearch/ui/api/UpgradeLifecycleContractTest.java` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:unanchored-general-19 — SCAN_MODE_FORCE_REINDEX is accepted by WorkerScanOps.ScanRequest (:364-378) but never consulted in t
`kind: defect?` `anchor: none` `seen: 1` `first: 2026-08-12` `last: 2026-08-12`
- [ ] SCAN_MODE_FORCE_REINDEX is accepted by WorkerScanOps.ScanRequest (:364-378) but never consulted in the scan body — the mode is inert, so no working re-tag route exists via scan (821 §L.3) (2026-08-12)

### obs:unanchored-flake-2 — CI flake (hosted-runner class): system-tests 'Indexing → action-ledger projection coherence (550 The
`kind: environment?` `anchor: none` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:unanchored-flake-9 — CI init-timeout flake cluster: system-tests tier 'initializationError' hit 3 different tests across 
`kind: environment?` `anchor: none` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:unanchored-error-2 — CI system-tests: on initializationError, IsolatedBackendFixture preserves isolated-backend-failure.l
`kind: follow-up?` `anchor: none` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:mmfworkersignalbus — isolated-backend boot flake ROOT CAUSE NARROWED (first captured worker.log, PR #434 run 31735720225,
`kind: environment?` `anchor: modules/indexer-worker/.../coordination/MmfWorkerSignalBus.java` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:knowledgeserverbootstrap — PRODUCTION BUG (boot-flake root cause, investigated 2026-08-13): transient KnowledgeServerBootstrap.
`kind: environment?` `anchor: KnowledgeServerBootstrap.java` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:ingestiondiagnosticscontracttest — H1 CONFIRMED (first captured headless-backend.log, run 31742266298, IngestionDiagnosticsContractTest
`kind: environment?` `anchor: IngestionDiagnosticsContractTest` `seen: 1` `first: 2026-08-13` `last: 2026-08-13`
...
### obs:unanchored-gate-red — The `publishing { repositories { … GitHubPackages … } }` blocks in `modules/app-api/build.gradle.kts
`kind: defect?` `anchor: none` `seen: 1` `first: 2026-07-29` `last: 2026-07-29`
...
### obs:unanchored-general-20 — CI 'Windows-native tests' has only ~2.3x timeout headroom: timeout-minutes: 15 (.github/workflows/ci
`kind: follow-up?` `anchor: none` `seen: 1` `first: 2026-07-29` `last: 2026-07-29`
...
### obs:unanchored-general-22 — gitignore gap: build-logic/.kotlin/ (Kotlin incremental-compilation cache, created by any build-logi
`kind: defect?` `anchor: none` `seen: 1` `first: 2026-07-29` `last: 2026-07-29`
- [ ] gitignore gap: build-logic/.kotlin/ (Kotlin incremental-compilation cache, created by any build-logic compile) is untracked and NOT gitignored, so it shows up as a dirty path in every worktree after a build and can be swept into a 'git add -A' on shared main. Sibling caches are ignored; this one appears to have been missed. Noticed during tempdoc 793 verification. (2026-07-29)

### obs:downloadexecutor — DownloadExecutor.CURL_RANGE_ERROR (=33) added by PR #412 is never read (errorprone UnusedVariable, w
`kind: defect?` `anchor: modules/app-services/src/main/java/io/justsearch/app/services/ai/install/DownloadExecutor.java` `seen: 2` `first: 2026-08-12` `last: 2026-08-13`
