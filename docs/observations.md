...
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/controllers/AgentSessionController.ts` `seen: 5` `first: 2026-06-03` `last: 2026-08-25`
...
`kind: defect` `anchor: scripts/jseval/jseval/ui_check.py` `seen: 5` `first: 2026-06-12` `last: 2026-08-25`
...
`kind: defect?` `anchor: docs/reference/search-quality-register.md` `seen: 6` `first: 2026-06-24` `last: 2026-08-19`
...
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/components/chat/CitationsPanel.ts` `seen: 2` `first: 2026-05-21` `last: 2026-08-25`
...
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/components/ActionLedgerView.ts` `seen: 3` `first: 2026-08-19` `last: 2026-08-20`
...
`kind: defect?` `anchor: tokens.css` `seen: 3` `first: 2026-06-04` `last: 2026-08-19`
...
`kind: defect?` `anchor: scripts/dev/justsearch-dev-mcp/server.mjs` `seen: 5` `first: 2026-06-17` `last: 2026-08-18`
...
`kind: defect?` `anchor: modules/ui/src/main/java/io/justsearch/ui/api/SettingsController.java` `seen: 2` `first: 2026-06-20` `last: 2026-08-19`
...
`kind: defect?` `anchor: governance/agent-hooks.v1.json` `seen: 3` `first: 2026-07-01` `last: 2026-08-18`
...
`kind: defect?` `anchor: record-merge.mjs` `seen: 4` `first: 2026-07-07` `last: 2026-08-20`
...
`kind: environment?` `anchor: modules/app-services/src/main/java/io/justsearch/app/services/worker/SupervisionDecision.java` `seen: 2` `first: 2026-07-11` `last: 2026-08-19`
...
`kind: defect?` `anchor: ui-a11y-baseline.v1.json` `seen: 6` `first: 2026-07-12` `last: 2026-08-25`
...
- [ ] check-controls-a11y RED on main (untouched by F-054 work): title-on-disabled button > baseline 0 — `modules/ui-web/src/shell-v0/views/UnifiedChatView.ts:2138` (2026-08-19)
...
`kind: defect?` `anchor: scripts/ci/check-tempdoc-numbers.mjs` `seen: 9` `first: 2026-07-15` `last: 2026-08-19`
...
`kind: environment?` `anchor: expected-state.v1.json` `seen: 4` `first: 2026-07-15` `last: 2026-08-25`
...
`kind: defect?` `anchor: governance/consult-register.v1.json` `seen: 4` `first: 2026-07-15` `last: 2026-08-25`
...
`kind: defect?` `anchor: scripts/governance/gates/hook-integrity/enforcer.mjs` `seen: 5` `first: 2026-07-15` `last: 2026-08-25`
...
`kind: environment?` `anchor: scripts/governance/gates/operation-surface/enforcer.test.mjs` `seen: 2` `first: 2026-07-16` `last: 2026-08-25`
...
`kind: environment?` `anchor: docs/explanation/21-agent-analytics-pipeline.md` `seen: 2` `first: 2026-07-16` `last: 2026-08-19`
...
`kind: follow-up?` `anchor: run.mjs` `seen: 6` `first: 2026-07-16` `last: 2026-08-25`
...
`kind: defect?` `anchor: scripts/dev/run-gh.mjs` `seen: 3` `first: 2026-07-17` `last: 2026-08-19`
...
`kind: defect?` `anchor: modules/adapters-lucene/src/main/java/io/justsearch/adapters/lucene/runtime/HybridFusionUtils.java` `seen: 2` `first: 2026-07-29` `last: 2026-08-19`
...
`kind: defect?` `anchor: modules/adapters-lucene/src/main/java/io/justsearch/adapters/lucene/runtime/RagContextOps.java` `seen: 7` `first: 2026-08-06` `last: 2026-08-19`
...
`kind: environment?` `anchor: modules/ui-web/src/shell-v0/streaming/EnvelopeStream.test.ts` `seen: 14` `first: 2026-08-06` `last: 2026-08-25`
...
`kind: defect?` `anchor: scripts/jseval/jseval/ui_shot.py` `seen: 3` `first: 2026-08-06` `last: 2026-08-25`
...
`kind: defect?` `anchor: modules/ui/src/main/java/io/justsearch/ui/api/routes/AiRoutes.java` `seen: 2` `first: 2026-08-12` `last: 2026-08-25`
...
`kind: follow-up?` `anchor: scripts/agent-analytics/overhead-taxonomy.mjs` `seen: 3` `first: 2026-08-14` `last: 2026-08-19`
...
`kind: defect?` `anchor: URLSource.ts` `seen: 2` `first: 2026-08-12` `last: 2026-08-25`
...
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/components/RecentsMenu.ts` `seen: 7` `first: 2026-08-12` `last: 2026-08-20`
...
- [ ] strip-token-fallbacks --check RED on main (untouched by F-054 work): 6 design-token fallbacks remain in ActionLedgerView.ts (2) + RecentsMenu.ts (4) — `modules/ui-web/src/shell-v0/components/RecentsMenu.ts` (2026-08-19)
...
`kind: environment?` `anchor: tmp/knip-report.json` `seen: 2` `first: 2026-08-13` `last: 2026-08-25`
...
`kind: defect?` `anchor: modules/app-services/src/integrationTest/java/io/justsearch/app/services/gpl/LambdaMartBenchmarkTest.java` `seen: 2` `first: 2026-08-14` `last: 2026-08-19`
...
`kind: defect?` `anchor: modules/app-services/src/test/java/io/justsearch/app/services/worker/WatchedRootScanCollectionTest.java` `seen: 2` `first: 2026-08-14` `last: 2026-08-19`
...
`kind: defect?` `anchor: gates/dead-code/baseline.txt` `seen: 3` `first: 2026-08-18` `last: 2026-08-19`
...
`kind: environment?` `anchor: test_ui_proportion_gate.py` `seen: 3` `first: 2026-08-18` `last: 2026-08-25`
...
`kind: defect?` `anchor: ResolvedConfigBuilder.java` `seen: 2` `first: 2026-08-19` `last: 2026-08-19`
...
`kind: environment?` `anchor: modules/ui/src/test/java/io/justsearch/ui/api/SchemaMismatchStatusContractTest.java` `seen: 2` `first: 2026-08-18` `last: 2026-08-25`
...
`kind: defect?` `anchor: check-shape-handler-regen` `seen: 2` `first: 2026-08-18` `last: 2026-08-25`
...
### obs:score-session — score-session.mjs reads outcome?.task_type from outcomes.ndjson, but post-622 that field lives under
`kind: defect?` `anchor: scripts/agent-analytics/score-session.mjs` `seen: 2` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:test-preview-squash-message — scripts/ci/test-preview-squash-message.mjs is invoked by no workflow or runner — run-all-tests.mjs o
`kind: defect?` `anchor: test-preview-squash-message.mjs` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:edit-reread-hint-test — CORRECTED + FIXED 2026-08-20 (was: "otlp-sink-ensure.test.mjs mkdirs a real empty tmp/agent-telemetr
`kind: defect?` `anchor: scripts/agent-analytics/hooks/edit-reread-hint.test.mjs` `seen: 1` `first: 2026-08-20` `last: 2026-08-20`
...
### obs:analyze-session — Seven analytics scripts end in a bare top-level `main();` with no direct-run guard, so importing any
`kind: defect?` `anchor: scripts/agent-analytics/analyze-session.mjs` `seen: 2` `first: 2026-08-20` `last: 2026-08-20`
...
### obs:evaluate-session — WITHDRAWN (was: evaluate-session --fallback reads the flat `outcome.task_type` and so re-runs its he
`kind: defect?` `anchor: scripts/agent-analytics/evaluate-session.mjs` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:telemetry-io — RESOLVED in 858 P2/P6: the three forked exclusion matchers and their two divergent match rules are c
`kind: defect?` `anchor: scripts/agent-analytics/lib/telemetry-io.mjs` `seen: 2` `first: 2026-08-19` `last: 2026-08-20`
...
### obs:jfsearchtrace — The `<jf-search-trace>` search-explain panel is orphaned: SearchSurface (its only mount, `renderExpl
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/aggregate-substrate/components/JfSearchTrace.ts` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:dev-runner-drift-3 — Live datapoint for 844 D3/845 run-registry: a dev-runner run started via the CLI (node scripts/dev/d
`kind: defect?` `anchor: dev-runner.cjs` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:changeset-loader — Discipline-gate kernel protocol gap, measured live: a count-ratchet declared-growth changeset licens
`kind: defect?` `anchor: changeset-loader.mjs` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:unanchored-missing-6 — F-053 follow-up from a recency sweep (2026-08-19): two candidates the CE upgrade screen should add b
`kind: follow-up?` `anchor: none` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:test-agent-behavioral-789 — Full jseval pytest suite (scripts/jseval) fails collection on 4 test files needing optional extras n
`kind: environment?` `anchor: test_agent_behavioral_789.py` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:grpcsearchservice — CE skip reason is mislabeled: GrpcSearchService reports skipReason=DEADLINE_EXCEEDED for ANY Reranke
...
### obs:dev-tool-usage — tempdoc 844 3's justsearch-dev invocation counts appear to have been derived from main-session trans
`kind: defect?` `anchor: scripts/agent-analytics/dev-tool-usage.mjs` `seen: 1` `first: 2026-08-18` `last: 2026-08-18`
...
### obs:justsearch-dev-mcp-harness — justsearch-dev-mcp-harness.mjs starts and stops a real dev stack but reads like an inventory smoke t
...
### obs:world-state-test — world-state.test.mjs perf budget (10s) fails on this machine: CLI takes ~11.4s in isolation; subject
`kind: environment?` `anchor: scripts/agent-analytics/world-state.test.mjs` `seen: 3` `first: 2026-08-19` `last: 2026-08-25`
...
### obs:settingssurface — jf-enter-action-picker select lacks accessible name (axe select-name, critical; baselined for settin
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/views/SettingsSurface.ts` `seen: 5` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:contract — Dead StorageKey 'justsearch-high-contrast' declared in persistence/contract.ts but never read/writte
`kind: defect?` `anchor: modules/ui-web/src/persistence/contract.ts` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:secondary-views-behavior — secondary-views-behavior.md still describes the Settings Appearance tab's High-Contrast toggle synci
`kind: defect?` `anchor: docs/reference/secondary-views-behavior.md` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:ui-user-readiness — ui-user-readiness.md:144 also claimed vimMode is client-side-only preference; corrected alongside th
`kind: follow-up?` `anchor: docs/reference/ui-user-readiness.md` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:check-declared-surfaces — check-declared-surfaces verifies a governed region MOUNTS the declared engine but not that the decla
`kind: defect?` `anchor: scripts/ci/check-declared-surfaces.mjs` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:settingssurface-highcontrast-test — SettingsSurface unit tests (e.g. SettingsSurface.v15.test.ts) never import renderers/registry.js, so
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/views/SettingsSurface.highContrast.test.ts` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:i18n — Settings window deep-link cold boot renders raw i18n keys (settings.group.general, settings.search.p
...
### obs:citationresolve-test — ts-any ratchet has 4 undeclared silent-growth entries on main (citationResolve.test.ts, indexingProg
`kind: defect?` `anchor: citationResolve.test.ts` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:agentcitationresolver — AgentCitationResolver drops CitationMatchResult.sourceCoverage at its return (same shape of defect 8
`kind: defect?` `anchor: modules/app-agent/src/main/java/io/justsearch/agent/AgentCitationResolver.java` `seen: 3` `first: 2026-08-25` `last: 2026-08-25`
...
- [ ] Doc-level agent sources (chunkIndex -1) are NEVER examined but the response still stamps CROSS_ENCODER: AgentCitationResolver.java:98 wraps them as VerificationSource(c,'') -> RemoteDocumentService.java:546 sends List.of() -> CitationMatchOps.java:414 returns null for negative ordinals — FE renders 'Retrieved · not cited' over a source nothing looked at, groundingIncomplete false. Same false-verdict class as 865 PR-0's timeout case, on a more common path; belongs in 865 PR-1's scope (found by PR #548 review F1) — modules/app-services/src/main/java/io/justsearch/app/services/agent/AgentCitationResolver.java:98 (2026-08-25)

### obs:errorproneconventionsplugin — Local `gradlew test` cannot catch Error Prone defects in TEST sources: ErrorProneConventionsPlugin d
`kind: defect?` `anchor: build-logic/src/main/kotlin/conventions/ErrorProneConventionsPlugin.kt` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
- [ ] Local `gradlew test` cannot catch Error Prone defects in TEST sources: ErrorProneConventionsPlugin disables Error Prone on every non-`compileJava` task unless CI is set, so an InvalidLink/@Override defect in a *Test.java file is invisible locally and only fails in CI (hit in 865 PR-1 by a stale {@link} after a method rename). Repro locally with `CI=true ./gradlew.bat :modules:<m>:compileTestJava` — `build-logic/src/main/kotlin/conventions/ErrorProneConventionsPlugin.kt:69` (2026-08-25)

### obs:registry-v1-schema — governance $schema pointers are a broken class, not one instance: `declaration-kinds.v1.json` and `s
`kind: environment?` `anchor: governance/registry.v1.schema.json` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:check-theme-token-closure — RecentsMenu (global topbar chrome) styles against `--space-1`/`--radius-sm`/`--surface-raised`/`--bo
`kind: defect?` `anchor: check-theme-token-closure` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:unanchored-general-36 — observations conditions `obs:theme-token-closure-red` (seen 8) and `obs:accent-as-text-red` (seen 6)
...
### obs:modality — 864 review F7: test-isolation hazard introduced by the modal-owns-focus guard — modality depth is MO
`kind: lesson?` `anchor: modules/ui-web/src/shell-v0/primitives/modality.ts` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:urlprojector — URLProjector.flushPendingProjection and __flushPendingWriteForTest are byte-identical duplicate bodi
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/router/URLProjector.ts` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:unanchored-general-40 — Windows Smart App Control blocks the unsigned ggml CPU-variant DLLs in the shared native-bin (observ
`kind: follow-up?` `anchor: none` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:surfaceicons — core.system-surface is a live RAIL surface with no SURFACE_ICONS entry, so the System rail button fa
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/utils/surfaceIcons.ts` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:composition-surfaces-v1 — governance/composition-surfaces.v1.json has exactly one adopter (views/UnifiedChatView.ts); when 852
`kind: defect?` `anchor: governance/composition-surfaces.v1.json` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:consult-doc-hint — consult-doc-hint resolves ONE region first-match-wins (governed-regions.mjs:57 .find()); the broad s
`kind: defect?` `anchor: scripts/agent-analytics/hooks/consult-doc-hint.mjs` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:keyboardhandler — UnifiedChatView's j/k nav guard omitted SELECT (KeybindingRegistry.ts:163-167 includes it), so the w
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/utils/keyboardHandler.ts` `seen: 2` `first: 2026-08-19` `last: 2026-08-24`
...
### obs:857-ratified-batch — RESOLVED same session: 854 tempdoc collision — 854-fusion-residue-lane.md merged to main first (PR #
`kind: defect?` `anchor: docs/tempdocs/857-ratified-batch.md` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:check-a11y-closure — check-a11y-closure rule (5) never scans views/search-v3/** or views/security/** — its VIEWS_DIR walk
`kind: defect?` `anchor: scripts/ci/check-a11y-closure.mjs` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:resourcecatalog — i18n resource catalog missing key `index.unavailable` — raw key rendered as user-visible fallback te
`kind: defect?` `anchor: modules/ui-web/src/i18n/resourceCatalog.ts` `seen: 1` `first: 2026-08-19` `last: 2026-08-19`
...
### obs:steering-surfaces-v1 — steering-surfaces register omits `.resolveContextGate(` from runDirectiveChannels.callPatterns, so a
`kind: defect?` `anchor: governance/steering-surfaces.v1.json` `seen: 2` `first: 2026-08-20` `last: 2026-08-24`
...
### obs:sv3-sessions — sv3 record reconciliation blanks a delegate turn's question: dispatchShapeDriven persists no USER_ME
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/views/search-v3/sv3-sessions.ts` `seen: 1` `first: 2026-08-20` `last: 2026-08-20`
...
### obs:knowledgeserverbootrecoverytest — Flaky: KnowledgeServerBootRecoveryTest failed once with ConcurrentModificationException during a ful
`kind: environment?` `anchor: modules/app-services/src/test/java/io/justsearch/app/services/worker/KnowledgeServerBootRecoveryTest.java` `seen: 1` `first: 2026-08-20` `last: 2026-08-20`
...
### obs:themescatalog — check-color-tokens is RED on main since #527 (855 settings window) and is not in expected-state.v1.j
`kind: environment?` `anchor: modules/ui-web/src/shell-v0/themes/themesCatalog.ts` `seen: 1` `first: 2026-08-24` `last: 2026-08-24`
...
### obs:agentrunqueryservice — Agent resume rebuilds a FRESH AgentRequest with no effort rung, so a resumed run silently re-sizes a
`kind: defect?` `anchor: modules/app-agent/src/main/java/io/justsearch/agent/AgentRunQueryService.java` `seen: 1` `first: 2026-08-24` `last: 2026-08-24`
...
### obs:agentinteractionmapper — Live/record divergence, pre-existing: an agent `progress` event appends a live run-feed note but pro
`kind: environment?` `anchor: modules/app-agent/src/main/java/io/justsearch/agent/AgentInteractionMapper.java` `seen: 2` `first: 2026-08-24` `last: 2026-08-24`
...
### obs:sv3-composer-occlusion-measure — sv3-composer-occlusion fixtures capture emits a framework-selfcheck console error '[jf-control] no a
`kind: defect?` `anchor: scripts/jseval/tmp/ui-shot/sv3-composer-occlusion.measure.json` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:navigation — Browser-automation evidence from the off-screen MCP tab is not user-visible truth for anything rAF-g
`kind: follow-up?` `anchor: modules/ui-web/src/shell-v0/primitives/navigation.ts` `seen: 3` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:sv3main-navigation-test — Stale line-number citations into primitives/navigation.ts drift on every edit — the collapsed-row sk
`kind: follow-up?` `anchor: modules/ui-web/src/shell-v0/views/search-v3/Sv3Main.navigation.test.ts` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:check-controls-a11y-drift — check-controls-a11y reports a wrong line number for a finding (flagged Sv3Composer.ts:837, a CSS lin
`kind: defect?` `anchor: scripts/ci/check-controls-a11y.mjs` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:framelatch — RESOLVED by tempdoc 860 P3 (PR #544): NavigationController.measureCoalesced latched — measureFrame w
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/primitives/frameLatch.ts` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:check-shape-handler-regen-drift — check-shape-handler-regen --live is a guaranteed false positive: it compares eventSchema entries (ob
`kind: defect?` `anchor: scripts/ci/check-shape-handler-regen.mjs` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:unanchored-general-49 — GET /api/chat/conversations/{id}/history returns {"messages":[]} for a delegate conversation (storeB
...
### obs:helpsurface — HelpSurface's keyboard-shortcut comment is stale: it claims 'the only registered keybindings are mod
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/views/HelpSurface.ts` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:confirmdialog — ConfirmDialog's Enter guard is defeated by shadow retargeting: the listener is on document (`Confirm
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/components/ConfirmDialog.ts` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:sv3-record-evidenceprojection-test — Two unrelated tests both named 'T11' across the 859 PR-1/PR-1b files (delegate-question reconcile vs
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/views/search-v3/sv3-record.evidenceProjection.test.ts` `seen: 2` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:advisorytoasthost — Ctrl+Z has two independent authorities: AdvisoryToastHost binds it on document unconditionally, app-
`kind: defect?` `anchor: modules/ui-web/src/shell-v0/components/advisory/AdvisoryToastHost.ts` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:toolsearchcard — toolSearchCard sets SearchProvenance.matchCount = resultCount, claiming total-matches equals returne
`kind: environment?` `anchor: modules/ui-web/src/shell-v0/components/chat/toolSearchCard.ts` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:surfacecatalogclient — FE-only surfaces are silently evictable by any wire catalog refresh: rebuildIndex REPLACES entriesBy
`kind: defect?` `anchor: api/registry/SurfaceCatalogClient.ts` `seen: 2` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:agentcontextcompressor — AgentContextCompressor can strip a tool message's Excerpt: lines and write the result back with NO [
`kind: defect?` `anchor: modules/app-agent/src/main/java/io/justsearch/agent/AgentContextCompressor.java` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
### obs:test — 9 of 22 scripts/ci/*.test.mjs are wired into no workflow — same dead-layer failure mode ci.yml:113-1
`kind: defect?` `anchor: test.mjs` `seen: 1` `first: 2026-08-25` `last: 2026-08-25`
...
- [ ] Progress phase `context_gate_reapplied` is emitted by the loop but absent from PROGRESS_PHASE_LABELS, so it degrades to the backend's raw prose instead of a user-tier label — `modules/ui-web/src/shell-v0/views/runStepPresentation.ts:78` (2026-08-25)
...
`kind: follow-up?` `anchor: evidenceProjection.ts` `seen: 3` `first: 2026-06-05` `last: 2026-08-20` `status: parked (deferred — revisit per condition note (triage 2026-07-12))`
