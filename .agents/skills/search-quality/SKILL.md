...
name: search-quality
description: >-
  TRIGGER only for deep search-quality or retrieval work: modifying search
  orchestration, fusion weights, reranking, SPLADE encoding, BM25 tuning, eval
  code, or updating quality baselines. Do not load for ordinary search API
