...
description: >-
  TRIGGER when: editing files in docs/explanation/, docs/reference/,
  docs/how-to/, docs/decisions/, after creating/modifying canonical
  documentation, or when auditing docs for tempdoc-to-canonical drift. Loads the
