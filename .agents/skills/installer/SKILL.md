...
name: installer
description: >-
  TRIGGER when: editing modules/shell/ (Tauri/Rust), scripts/ci/, Cargo.toml,
  tauri.conf.json, NSIS scripts, or working on desktop packaging, installer,
...
- **Lean installer:** 249 MB shipped in v0.2.0 (JRE + Tauri shell + backend JARs), measured on the signed artifact; tempdoc 772 / CI run 29901314606 measured ~260 MB pre-release
