...
name: review-changes
description: >-
  Critically review implemented changes against the tempdoc/spec, report
  verification claims with evidence pointers, and get an independent
  refute-first subagent check before fixing issues.
---
