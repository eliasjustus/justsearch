...
description: >-
  Review an implemented tempdoc to determine whether its claimed or concretely
  implied capabilities are connected, discoverable, and usable through their
  intended product and development paths.
---
