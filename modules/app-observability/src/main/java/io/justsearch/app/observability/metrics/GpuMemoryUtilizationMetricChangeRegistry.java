...
/**
 * Listener-based broadcast for the {@code gpu.memory.utilization.percent} TIMESERIES
 * Resource — slice 3a.1.4b cohort follow-up.
 */
public final class GpuMemoryUtilizationMetricChangeRegistry {

  public static final StreamId STREAM_ID =
      StreamId.surface("metric-gpu-memory-utilization-percent");

  private final SseStreamChannel channel;

  public GpuMemoryUtilizationMetricChangeRegistry() {
