...
/**
 * The composer's effort control (tempdoc 822 Phase F10) — the §4b ADAPTATION RATIFIED: the donor's
...
describe('the control presents the donor menu anatomy', () => {
  it('opens a labelled radio menu with the current rung checked and the default badged', async () => {
    ...
    // The donor badges the provider's own default rung (TraitsPicker.tsx:334-339).
    expect(
