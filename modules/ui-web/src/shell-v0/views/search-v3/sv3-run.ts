 ...
 *
 * Four donor patterns it realizes (820 §2d, mined from the T3 Code clone):
 *
...
/**
 * The ONE value rendering reads. Five, not four: the donor's four phases assume the dispatch is
...
/* ── Typed pending states (donor pattern 4) ──────────────────────────────────────────────────── */
...
/* ── The optimistic-handoff predicate (donor pattern 2) ──────────────────────────────────────── */
...
/* ── The primary-action slot (donor pattern 3) ───────────────────────────────────────────────── */

/**
 * The four rungs, in strict priority order. Exactly ONE is ever rendered — the donor's
 * `ComposerPrimaryActions` early-returns rather than disabling the loser, and F1 made that structural
