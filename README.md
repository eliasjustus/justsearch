...
variable before launching; the actual port in use is always written to the `head.apiPort`
field of `%APPDATA%\io.justsearch.shell\runtime\manifest.json`. Details + a 2-minute Claude Desktop walkthrough:
